...
export const grantRawPermissions = async (page: Page, permissions: string[]) => {
...
export const grantClipboardPermissions = (page: Page) => grantRawPermissions(page, ['clipboardReadWrite', 'clipboardSanitizedWrite']);